...
Setup =guix-config.scm= which utilizes =guix-home-service-type= to combine system
and home and specify package subsitutes & channels via
=specifications->tranformations= function.

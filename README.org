...
* Introduction
  ...
  My personal Guix System & Home Configuration with StumpWM and Nyxt.  The goal is
  to have a system that incorporates as much Lisp configurations as possible, i.e.
  Guile Scheme, Common Lisp (StumpWM & Nyxt), Emacs Lisp.  Those three alone
  encapsulates 99% of my workflow (Emacs being the workhorse!)...
